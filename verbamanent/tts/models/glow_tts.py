...
from verbamanent.tts.layers.glow_tts.decoder import Decoder
from verbamanent.tts.layers.glow_tts.encoder import Encoder
...
class Glowtts(Basetts):
    ...
    @staticmethod
    def get_criterion():
        from verbamanent.tts.layers.losses import GlowttsLoss  # pylint: disable=import-outside-toplevel
