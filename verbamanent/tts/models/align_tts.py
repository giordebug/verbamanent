...
from verbamanent.tts.layers.align_tts.mdn import MDNBlock
from verbamanent.tts.layers.feed_forward.decoder import Decoder
from verbamanent.tts.layers.feed_forward.duration_predictor import DurationPredictor
...
from verbamanent.tts.utils.visual import plot_alignment, plot_spectrogram
...
class Aligntts(Basetts):
    ...
    def get_criterion(self):
        from verbamanent.tts.layers.losses import AlignttsLoss  # pylint: disable=import-outside-toplevel
