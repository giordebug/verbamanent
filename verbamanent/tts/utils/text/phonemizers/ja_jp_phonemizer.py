...
from verbamanent.tts.utils.text.japanese.phonemizer import japanese_text_to_phonemes
...
class JA_JP_Phonemizer(BasePhonemizer):
    ...
    Example:
        ...
        >>> from verbamanent.tts.utils.text.phonemizers import JA_JP_Phonemizer
