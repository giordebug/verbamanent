...
from verbamanent.vocoder.configs.shared_configs import BaseVocoderConfig
from verbamanent.vocoder.models.wavegrad import WavegradArgs
...
class WavegradConfig(BaseVocoderConfig):
    ...
    Args:
        ...
        generator_model (str): One of the generators from verbamanent.vocoder.models.*`. Every other non-GAN vocoder model is
