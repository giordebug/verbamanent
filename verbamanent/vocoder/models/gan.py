...
from verbamanent.vocoder.datasets.gan_dataset import GANDataset
from verbamanent.vocoder.layers.losses import DiscriminatorLoss, GeneratorLoss
from verbamanent.vocoder.models import setup_discriminator, setup_generator
...
class GAN(BaseVocoder):
    def __init__(self, config: Coqpit, ap: AudioProcessor = None):
        ...
        Examples:
            ...
            >>> from verbamanent.vocoder.configs import HifiganConfig
