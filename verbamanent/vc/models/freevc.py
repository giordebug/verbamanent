...
import verbamanent.vc.modules.freevc.commons as commons
import verbamanent.vc.modules.freevc.modules as modules
from verbamanent.tts.utils.speakers import SpeakerManager
from verbamanent.utils.io import load_fsspec
from verbamanent.vc.configs.freevc_config import FreeVCConfig
from verbamanent.vc.models.base_vc import BaseVC
from verbamanent.vc.modules.freevc.commons import get_padding, init_weights
from verbamanent.vc.modules.freevc.mel_processing import mel_spectrogram_torch
from verbamanent.vc.modules.freevc.speaker_encoder.speaker_encoder import SpeakerEncoder as SpeakerEncoderEx
from verbamanent.vc.modules.freevc.wavlm import get_wavlm
...
class FreeVC(BaseVC):
    ...
    Examples:
        >>> from verbamanent.vc.configs.freevc_config import FreeVCConfig
        >>> from verbamanent.vc.models.freevc import FreeVC
        >>> config = FreeVCConfig()
        >>> model = FreeVC(config)
    """
